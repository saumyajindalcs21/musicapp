...
const MusicScreen8 = () => {
  const songUrl = 'https://pwdown.info/111724/01.%20Khilona%20Jaan%20Kar.mp3'; // Replace with your song URL
  const songName = 'Khilona Jaan Kar';
  const singername = 'Unknown';
  const songimage = { uri: 'https://www.pagalworld.link/GpE34Kg9Gq/111724/thumb-khilona-1970-300.jpg' };
