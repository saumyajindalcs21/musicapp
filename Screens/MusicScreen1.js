...
const MusicScreen1 = () => {
  const songUrl = 'https://pwdown.info/110433/07.%20Mere%20Dholna.mp3'; // Replace with your song URL
  const songName = 'Mere Dholna';
  const singername = 'Unknown';
  const songimage = { uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTNQc72UlQORyB-jLXeaJlPZUCrMSedU4kwrw&usqp=CAU' };
